...
contract ArbitrationTest {
    ...
    function testUnauthorizedRefund() public {
        ...
        Assert.isFalse(winner.callRefund(), "unauthorized refund call should be rejected1");
        Assert.isFalse(other.callRefund(), "unauthorized refund call should be rejected2");
        setupContracts(true, false);
        Assert.isFalse(judge.callRefund(), "unauthorized refund call should be rejected3");
    }
